						...
						<div id="navbarMenuHeroA" class="navbar-menu">
							<div class="navbar-end">
								<a class="navbar-item" href="<c:url value = "/home"/>"> Home
									...
									href="<c:url value = "/howItWorks"/>"> How it works </a> <a
									class="navbar-item" href="<c:url value = "leaderboard"/>">
									Leaderboard </a> <a class="navbar-item"
									href="<c:url value = "/shop"/>"> Shop </a>
								<%--<a class="navbar-item"
	              ...
	              Podcast 
		            ...
		            <span id = "login-section" class="navbar-item">
		              ...
		              <input name = "password" id = "login-password" class = "input is-small is-warning" type = "password" placeholder = "password"/>
								...
								<a class="navbar-item" href="<c:url value = "signUp"/>">
									Sign Up </a>
							</div>
						</div>
					</div>
