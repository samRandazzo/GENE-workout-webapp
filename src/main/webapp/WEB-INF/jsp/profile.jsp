...
=======
	<h2>Welcome, ${sessionScope.currentUser.userName}</h2>
	<!--   <section class="section">
>>>>>>> 51e3ecac3af3249852fe996d8a90c5cbbc998cd6
    <div class="container">
		...
		<div class="tile is-parent">
			<article class="tile is-child box">
				...
				<script>
					...
					start = document.getElementById('start'), stop = document
							.getElementById('stop'), clear = document
							.getElementById('clear'), seconds = 0, minutes = 0,
							hours = 0, t;
