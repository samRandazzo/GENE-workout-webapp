...
<section id = "sign-up-form" class = "section">
	<div class = "container">
		...
		<h1 class="title has-text-white">New User Sign Up</h1>
		...
		<div class = "field">
			<label class = "label is-warning">User Name</label>
			<div class = "control">
				<form:input class = "input is-warning form-control" path="userName" 
							id="userName" name="userName" type = "text"
							placeholder = "(must be between 5 and 32 characters)"/>
			</div>
				<form:errors path="userName" cssClass="error"/>
		</div>
			
		<div class="field">
			<label class = "label is-warning">Password</label>
			<div class = "control">
				<form:input class = "input is-warning form-control" path="password" 
							id="password" name="password" type="password"
							placeholder = "(at least 1 uppercase letter, 1 lowercase letter, 10 characters long)"/>
			</div>
